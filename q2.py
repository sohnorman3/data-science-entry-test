def find_and_replace(lst, find_val, replace_val):
    ...
    """
    if not isinstance(lst, list): #checking isinstance compare if object lst is a list. "Not" function compare if the false it will trigger input must be a list below
