def string_reverse(s):
    ...
    return s[::-1]  # Reverse the string using slicing. [Start,end, step] with [::-1] we are defining default all beginning and default ending with a negative 1 left to right order.
