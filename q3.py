def update_dictionary(dct, key, value):
    ...
    """
    if not isinstance(dct, dict): #compare if object dct is a Dict with isinstance. When false it will trigger next line
...
dict1 = {}
result1 = update_dictionary(dict1, "name", "Alice") #update dictionary with new key-Value name:Alice, Ordered if there are data updated infor will be placed last
print(result1)  # Output: {'name': 'Alice'}

# Test Case 2: Updating an existing key in a dictionary
dict2 = {"age": 25}
result2 = update_dictionary(dict2, "age", 26) # Dict will update the latest value for key value pair
